...
bucket_suffix = "assets-dev-20260416"
...
ec2_instances = {
  "web-server-1" = { ami_id = "ami-05d2d839d4f73aafb", instance_type = "t3.micro", subnet_key = "public-subnet-1" }
  "web-server-2" = { ami_id = "ami-05d2d839d4f73aafb", instance_type = "t3.micro", subnet_key = "public-subnet-2" }
}
